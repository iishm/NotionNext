...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'IISHM', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '工程结构智慧监测', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://danlab,xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '工程结构,智慧,监测', // 网站关键词 英文逗号隔开
